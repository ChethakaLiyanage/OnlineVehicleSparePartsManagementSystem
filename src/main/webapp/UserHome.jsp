        ...
        * {
        ...
        .hero {
            ...
            background: linear-gradient(to right, rgba(11, 15, 61, 0.9), rgba(11, 15, 61, 0.7)),
                        url('https://cdn.pixabay.com/photo/2012/05/29/00/43/car-49278_1280.jpg') center center / cover no-repeat;
            display: flex;
            flex-direction: column;
...
<section class="hero">
    <% if (user != null) { %>
           ...
           <h1>Welcome <%= user.getName() %> to the Auto Parts </h1>
           <p>This is your central hub to manage and monitor the entire eSpareMart system efficiently.</p>
            <% } else { %>
                <h2>System Overview</h2>
                <h1>Welcome to the Auto Parts </h1>
                <p>This is your central hub to manage and monitor the entire eSpareMart system efficiently.</p>
            <% } %>
...
<!-- Footer -->
<footer>
     v1.0 — © 2025 <strong>eSpareMart</strong>. All rights reserved.
    <br>
