...
<head>
    <meta charset="UTF-8">
    <title>Manage Suppliers | AutoVio Admin</title>
...
<div class="container">
    <h2>Manage Supplier Accounts</h2>

    <button class="btn add-btn" onclick="location.href='AdminAddSupplier.jsp'">+ Add Supplier</button>
        ...
        <tbody>
            <c:forEach var="s" items="${supplierList}">
                <tr>
                    ...
                    <td>${s.supplierusername}</td>
                    <td>${s.supplierphone}</td>
                    <td>${s.supplierpassword}</td>
                    <td>
                        <a href="AdminEditSupplier.jsp?supplierid=${s.supplierid}&suppliername=${s.suppliername}&supplieremail=${s.supplieremail}&supplierphone=${s.supplierphone}">
                            <button class="btn btn-primary">Update</button>
                        </a>
                    </td>
                    <td>
                        <form action="AdminDeleteSupplierServlet" method="post" onsubmit="return confirm('Delete this supplier?');">
