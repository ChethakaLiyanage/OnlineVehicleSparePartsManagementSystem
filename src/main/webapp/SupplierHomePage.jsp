...
<head>
    ...
    <title>Supplier Home | AutoVio</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<!-- Navbar -->
<div class="navbar">
    <div class="logo">AutoVio Supplier </div>
    <nav>
...
<section class="hero">
    ...
    <h1>Welcome to the Auto Parts Supplier Portal</h1>
    <p>This is your central hub to manage and monitor the entire AutoVio system efficiently.</p>
    
    <a href="SupplierDashboardServlet" class="go-btn">Go to Dashboard</a>
