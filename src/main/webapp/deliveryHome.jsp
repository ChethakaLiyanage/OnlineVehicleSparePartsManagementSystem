...
<head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Delivery Person Home | AutoVio</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<section class="hero">
    ...
    <h1>Welcome to the Auto Parts Delivery personal Portal</h1>
    <p>This is your central hub to manage and monitor the entire AutoVio system efficiently.</p>
    
    <a href="dashboard.jsp" class="go-btn">Go to Dashboard</a>
...
<!-- Footer -->
<footer>
    Delivery personal Portal v1.0 — © 2025 <strong>AutoVio</strong>. All rights reserved.
    <br>
